...
class Menus {
	...
	public function register_menus() {
		register_nav_menus([
			'gcc-header-menu' => esc_html__( 'Header Menu', 'gcc' ),
			'gcc-footer-menu' => esc_html__( 'Footer Menu', 'gcc' ),
			'Banking and financial markets' => esc_html__( 'About Banking & financial Menu', 'gcc' ),
			'Automotive and Transportation' => esc_html__( 'About automotive & transportation menu', 'gcc' ),
		]);
	}
